...
void main()
{
    ...
    // This is crucial: NO distortion in the vertex shader!
    // All water effects will be handled in the fragment shader
    // By doing this, we prevent the vertices from moving when the player moves
