...
// Metallic parameters
float reflectionSpeed = 0.7; // Speed of reflection movement
float reflectionIntensity = 0.045; // Intensity of reflective highlights
float armorSegmentSize = 0.18; // Size of armor segments/plates
