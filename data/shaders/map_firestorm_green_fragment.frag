...
const vec3 FIRE_COLOR1 = vec3(0.2, 0.9, 0.3); // Green
const vec3 FIRE_COLOR2 = vec3(0.1, 0.5, 0.1); // Deep green
const vec3 FIRE_COLOR3 = vec3(0.5, 1.0, 0.3); // Bright green
...
void main() {
    ...
    // Add ash particles (dark green/black)
    color.rgb = mix(color.rgb, vec3(0.15, 0.25, 0.15), ash * 0.3);
