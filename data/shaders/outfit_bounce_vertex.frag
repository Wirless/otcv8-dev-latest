...
// Bounce parameters
float bounceHeight = 0.03; // Height of bounce
float bounceSpeed = 2.0; // Speed of bouncing
float squashFactor = 0.15; // How much to squash on landing
float stretchFactor = 0.05; // How much to stretch at peak
