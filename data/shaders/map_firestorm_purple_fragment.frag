...
const vec3 FIRE_COLOR1 = vec3(0.7, 0.3, 0.9); // Purple
const vec3 FIRE_COLOR2 = vec3(0.5, 0.0, 0.5); // Deep purple
const vec3 FIRE_COLOR3 = vec3(1.0, 0.4, 1.0); // Light purple/pink
...
void main() {
    ...
    // Add ash particles (dark purple/black)
    color.rgb = mix(color.rgb, vec3(0.15, 0.08, 0.2), ash * 0.3);
