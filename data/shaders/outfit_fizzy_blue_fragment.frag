...
// Fizzy Blue parameters
float blueIntensity = 0.25; // Intensity of blue coloring
...
void main() {
    ...
    // Create blue fizzy soda effect
    // Mix with blue color
    vec3 blueColor = vec3(0.2, 0.5, 1.0); // Bright blue
    baseColor.rgb = mix(baseColor.rgb, blueColor, blueIntensity);
    ...
    baseColor.rgb += vec3(0.9, 0.95, 1.0) * sparkle * 0.5; // Blueish white sparkles
