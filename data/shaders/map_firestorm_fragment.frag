...
const vec3 FIRE_COLOR1 = vec3(1.0, 0.5, 0.0); // Orange
const vec3 FIRE_COLOR2 = vec3(0.9, 0.2, 0.0); // Deep red
const vec3 FIRE_COLOR3 = vec3(1.0, 0.7, 0.3); // Yellow
...
void main() {
    ...
    // Add ash particles (grey/black)
    color.rgb = mix(color.rgb, vec3(0.2, 0.2, 0.2), ash * 0.3);
